...
public sealed class AlpacaTest : IMarketDataFeedAdapter, IAsyncDisposable
{
    ...
    {
        await _socket.ConnectAsync(new Uri(_configuration["AlpacaMarket:StockWsUrlTest"]!), ct);
